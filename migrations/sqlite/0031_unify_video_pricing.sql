...
ALTER TABLE model_pricing ADD COLUMN base_credits INTEGER NOT NULL DEFAULT 0;
ALTER TABLE model_pricing ADD COLUMN per_second INTEGER NOT NULL DEFAULT 0;
